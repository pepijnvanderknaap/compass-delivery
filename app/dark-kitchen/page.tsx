          ...
          {sections.map((section) => (
            section.available ? (
              <Link
                key={section.href}
                href={section.href}
                className="group relative overflow-hidden bg-white border border-blue-200 rounded-lg p-8 hover:border-blue-700 hover:shadow-lg transition-all duration-300"
              >
                <div className="text-blue-700 mb-6 group-hover:text-blue-900 group-hover:scale-110 transition-all duration-300">
                  {section.icon}
                </div>
