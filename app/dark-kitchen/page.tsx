...
export default function DarkKitchenPage() {
  ...
  const sections = [
    { title: 'Dishes', href: '/admin/dishes', description: 'Create and manage dish options', icon: '🍽️', available: true },
    { title: 'Menu Planner', href: '/admin/menus', description: 'Set up weekly menu offerings', icon: '📋', available: true },
    { title: 'Recipes', href: '#', description: 'Coming soon', icon: '📖', available: false },
    { title: 'Production Sheets', href: '#', description: 'Coming soon', icon: '📊', available: false },
  ];
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-end gap-8">
              ...
              <div className="border-l-2 border-gray-300 pl-8 pb-1">
                <h1 className="text-xl font-semibold text-gray-900">Dark Kitchen</h1>
