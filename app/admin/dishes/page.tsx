      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
        ...
        <div className="mb-8 flex justify-between items-center">
          ...
          <button
            ...
            className="px-8 py-3 bg-slate-600 text-white rounded-md hover:bg-slate-700 font-medium shadow-sm transition-colors"
          >
            + Add New
          </button>
        </div>
            ...
            {mainCategories.map(category => {
              ...
              return (
                <div key={category.key} className="bg-white rounded-lg border border-black/10 overflow-hidden">
                  <div className="px-4 py-3 border-b border-black/5 bg-slate-100">
                  ...
                  <div className="p-3">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-black/10 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                    />
                    {dishes.length === 0 ? (
