    ...
    try {
      ...
      if (data.user) {
        ...
        if (profile && (profile.role === 'admin' || profile.role === 'manager')) {
          router.push('/atlassian/dashboard');
          router.refresh();
        } else {
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl border-2 border-[#E8E8ED] shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <div className="mb-4">
              <Image
                src="/locations/atlassian-logo.png"
                alt="Atlassian"
                width={200}
                height={80}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-[#D2D2D7] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-[#0078D4] transition-all"
