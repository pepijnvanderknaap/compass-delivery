          ...
          <form id="main-dish-form" onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                autoFocus
                className="w-full px-4 py-3 border border-apple-gray4 rounded-sm text-apple-subheadline focus:border-[#0078D4] focus:ring-2 focus:ring-[#0078D4]/20 outline-none transition-all"
              />
            </div>
                  ...
                  <div className="mt-4 p-6 border border-apple-gray5 rounded-sm bg-apple-gray7 space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 border border-apple-gray4 rounded-sm text-apple-subheadline focus:border-[#0078D4] focus:ring-2 focus:ring-[#0078D4]/20 outline-none transition-all resize-none bg-white"
                      />
                    </div>
                  </div>
                )}
                  ...
                  {[
                    ...
                    <label key={allergen.key} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-5 h-5 text-[#0078D4] border-apple-gray4 rounded focus:ring-[#0078D4]/20"
                      />
                  ...
                  <div className="mb-6 p-5 bg-[#0078D4]/5 border-2 border-[#0078D4] rounded-sm">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        className="w-6 h-6 text-[#0078D4] border-[#0078D4] rounded focus:ring-[#0078D4]/20"
                      />
                      <span className="text-[17px] font-semibold text-[#0078D4]">
                        ...
                        <div key={subcat.key} className="border border-apple-gray5 rounded-sm p-5">
                          ...
                          <div className="flex gap-3 mb-4">
                            <button
                              ...
                              className="flex-1 px-4 py-3 text-[15px] font-medium text-white bg-[#0078D4] hover:bg-[#106EBE] rounded-sm transition-colors flex items-center justify-center gap-2"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                              ...
                              className="flex-1 px-4 py-3 text-[15px] font-medium text-[#0078D4] border-2 border-[#0078D4] hover:bg-[#F5F5F7] rounded-sm transition-colors flex items-center justify-center gap-2"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      return (
                        <div key={subcat.key} className="border border-apple-gray5 rounded-sm p-5">
                          ...
                          <button
                            ...
                            className="w-full px-4 py-3 text-[15px] font-medium text-white bg-[#0078D4] hover:bg-[#106EBE] rounded-sm transition-colors flex items-center justify-center gap-2 mb-4"
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                            </svg>
                      ...
                      <div key={subcat.key} className="border border-apple-gray5 rounded-sm p-5">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <button
                            ...
                            className="text-apple-subheadline text-[#0078D4] hover:text-[#106EBE] font-medium transition-colors"
                          >
                            + New
                          </button>
                        </div>
                        {totalCount > 12 && (
                          <input
                            ...
                            className="w-full px-4 py-3 text-apple-subheadline border border-apple-gray4 rounded-sm mb-3 focus:border-[#0078D4] focus:ring-2 focus:ring-[#0078D4]/20 outline-none transition-all"
                          />
                        )}
                        {components.length === 0 ? (
