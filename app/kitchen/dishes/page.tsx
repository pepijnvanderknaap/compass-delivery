  ...
  return (
    <div className="min-h-screen bg-white font-apple">
      ...
      <UniversalHeader
        ...
        navItems={[
          { label: 'Week Overview', href: '/kitchen/week-overview', active: false },
          {
            ...
            active: true,
            subItems: [
              { label: 'Dish Library', href: '/kitchen/dishes', active: true },
      ...
      <main className="max-w-7xl mx-auto px-8 lg:px-12 py-24">
        ...
        <div className="mb-12">
          <div className="flex justify-between items-end mb-6">
            ...
            <button
              ...
              className="px-6 py-2.5 text-[15px] font-medium bg-white border-2 border-[#D2D2D7] text-[#1D1D1F] hover:bg-[#F5F5F7] rounded-sm transition-colors"
            >
              + Add New
            </button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border border-[#D2D2D7] rounded-sm overflow-hidden shadow-sm">
              <table className="w-full border-separate" style={{borderSpacing: '0 0'}}>
                ...
                <tbody>
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      <input
                        type="text"
                        placeholder="Search..."
                        value={categorySearchTerms['soup'] || ''}
                        onChange={(e) => setCategorySearchTerms({ ...categorySearchTerms, soup: e.target.value })}
                        className="w-full px-3 py-2 text-[15px] border border-[#D2D2D7] rounded-sm mb-3 focus:outline-none focus:ring-2 focus:ring-[#0078D4]/20 focus:border-[#0078D4] bg-white"
                      />
                      {getFilteredMainDishes('soup').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No soups</p>
                      ) : (
                        <div className="space-y-1">
                          {getFilteredMainDishes('soup').slice(0, 3).map(dish => (
                            <div key={dish.id} className="py-2 px-2 hover:bg-[#F5F5F7] rounded-sm text-[15px]">
                              <div className="flex items-center justify-between gap-2">
                                <span className="text-[#1D1D1F] flex-1 font-medium break-words">{dish.name}</span>
                                <div className="flex gap-1.5 flex-shrink-0">
                                  <button
                                    onClick={() => handleEditMainDish(dish)}
                                    className="px-3 py-1.5 text-xs font-medium bg-[#F5F5F7] border border-[#D2D2D7] text-[#1D1D1F] rounded hover:bg-[#E8E8ED] transition-colors whitespace-nowrap"
                                  >
                                    Edit
                                  </button>
                                  <button
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredComponentDishes('topping').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No toppings</p>
                      ) : (
                        <div className="space-y-1">
        ...
        {/* Hot Dishes Section */}
        <div className="mb-12">
          <h2 className="text-[22px] font-semibold mb-6 text-[#1D1D1F]">
            Hot Dishes
          </h2>
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredMainDishes('hot_dish_meat').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No meat dishes</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredMainDishes('hot_dish_fish').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No fish dishes</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredMainDishes('hot_dish_veg').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No veg dishes</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredComponentDishes('carb').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No carbs</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredComponentDishes('warm_veggie').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No warm vegetables</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <tr>
                    <td className="bg-[#F5F5F7] p-3">
                      ...
                      {getFilteredComponentDishes('condiment').length === 0 ? (
                        <p className="text-[#86868B] text-[15px] py-4 text-center">No add-ons</p>
                      ) : (
                        <div className="space-y-1">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-2 text-[#86868B] hover:text-[#0071E3] hover:bg-[#F5F5F7] rounded-sm transition-colors"
                        title="Edit salad"
                      >
                      ...
                      <button
                        ...
                        className="p-2 text-[#86868B] hover:text-red-600 hover:bg-red-50 rounded-sm transition-colors"
                        title="Delete salad"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
