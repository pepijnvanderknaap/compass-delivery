...
import DishCommandPalette from '../../admin/menu-planner/components/DishCommandPalette';
import DishDetailModal from '../../admin/menu-planner/components/DishDetailModal';
                                ...
                                {dish ? (
                                  <div className="relative group w-full h-full rounded-sm p-2 flex items-center justify-center">
                                    ...
                                    <button
                                      ...
                                      className="absolute -top-1.5 -right-1.5 bg-[#6E6E73] hover:bg-[#1D1D1F] text-white rounded-full w-5 h-5 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-all duration-200"
                                    >
                                      ×
                                    </button>
                                  </div>
