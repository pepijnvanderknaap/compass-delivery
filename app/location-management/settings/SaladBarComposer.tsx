    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-xs text-gray-600">
              <span className="font-bold text-teal-700">{totalPortionSize}g</span> total
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {SALAD_BAR_ELEMENTS.map((element) => {
          ...
          return (
            <div key={element.key} className="bg-white border border-gray-200 rounded-md p-2 hover:border-teal-300 transition-colors">
