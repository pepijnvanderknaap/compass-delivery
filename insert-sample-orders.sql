-- Insert sample orders for Monday, January 27, 2025
-- Based on your actual location and dish names

DO $$
DECLARE
  snapchat_id uuid := '5c5af765-0845-452c-8c27-c3842af85a4f'; -- SnapChat 165
...
BEGIN
  ...
  RAISE NOTICE 'Sample orders created successfully for 5 locations!';
END $$;
