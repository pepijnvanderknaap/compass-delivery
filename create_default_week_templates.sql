-- Create table for storing default week templates per location
CREATE TABLE IF NOT EXISTS default_week_templates (
  ...
  hot_dish_meat INTEGER NOT NULL DEFAULT 0,
  hot_dish_fish INTEGER NOT NULL DEFAULT 0,
